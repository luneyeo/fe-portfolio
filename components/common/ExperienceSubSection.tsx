...
export default function SubSection({
  ...
  return (
    <div className="flex flex-col gap-4 rounded-2xl bg-gray-50 p-6 sm:gap-6 md:flex-row lg:p-8">
      <div className="flex w-fit shrink-0 items-center gap-2 sm:w-20 sm:flex-col lg:w-24">
      ...
      <div className="relative flex-1 border-t-2 border-olive-500/60 pt-4 sm:pt-7 md:border-t-0 md:border-l-2 md:pt-0 md:pl-7">

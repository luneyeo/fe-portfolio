...
export const projects: Project[] = [
  {
    ...
    types: ['팀 프로젝트', '웹/모바일'],
    description:
      '캘린더 및 지도 SDK를 활용해 예약 가능한 날짜 설정과 체험 상품 예약 기능을 구현한 웹 애플리케이션입니다.\n사용자가 판매자와 체험자 역할을 동시에 수행할 수 있는 구조로, 상품 등록, 조회, 예약 등 복합적인 기능을 제공합니다. 여러 페이지와 세부 기능을 동시에 처리해야 하므로, UI 관리 경험을 쌓고, 서비스 운영 과정에서 발생하는 문제를 해결하며 실무에 가까운 경험을 얻었습니다.',
    features: [
      '체험 검색 및 필터링',
      '상세 정보 확인 및 예약',
      '사용자 인증(로그인/회원가입)',
  ...
  },
  {
    ...
    types: ['팀 프로젝트', '웹/모바일'],
    description:
      'Taskify는 일정 관리와 커뮤니티 기능을 결합한 웹 애플리케이션으로, 사용자들이 그룹을 생성하고 멤버와 함께 일정 및 할 일을 관리할 수 있는 서비스입니다. \n 카드 기반 UI를 통해 일정과 할 일을 공유하고, CRUD, 초대, 댓글, 검색 기능을 제공하여 협업 중심의 사용 경험을 구현했습니다. TypeScript와 다양한 UI 라이브러리를 활용해 복잡한 상태를 안정적으로 관리하고, 사용성과 가독성을 개선했습니다.',
    features: [
      '사용자 인증(로그인/회원가입)',
      '대시보드 생성 및 관리',
      '할 일 카드 생성/수정/삭제',
